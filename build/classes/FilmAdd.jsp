...
<html lang="en">
  <head>
    ...
    <script src="/WEB-INF/scripts/filmAdd.js"></script>
  </head>
  <body>
	<h1>Add new Film with ID: <c:out value="${id }"></c:out></h1>
<form action="WebFilm?action=addFilmPOST&id=${id }" method="post" name="myForm">
